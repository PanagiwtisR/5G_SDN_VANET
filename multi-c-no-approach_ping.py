...
def topology():
    ...
    car3 = net.addStation('car3', mac='02:00:00:00:00:03',
                          position='400,200,0') #, active_scan=1)
    ...
    car5 = net.addStation('car5', mac='02:00:00:00:00:05',
                          position='370,150,0') #, active_scan=1)

    car6 = net.addStation('car6', mac='02:00:00:00:00:05',
                          position='370,250,0') #, active_scan=1)
    cars.append(car1)
    cars.append(car2)
    cars.append(car3)
    cars.append(car4)
    ...
    makeTerm(cars[0], cmd="bash -c 'ping 10.0.0.100 -c200 > ping_no_slicing.txt;'")
    ...
    while j<3:
        if (time.time() - currentTime) >= i:
            currentTime = time.time()
            if j == 0:
                cars[0].setPosition('270,180,0')
            else:
                cars[0].setPosition('340,180,0')
            j+=1
